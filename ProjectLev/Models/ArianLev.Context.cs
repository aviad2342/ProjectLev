...
namespace ProjectLev.Models
{
    ...
    public partial class arivanLevEntities : DbContext
    {
        public arivanLevEntities()
            : base("name=arivanLevEntities")
        {
        }
        ...
        public virtual DbSet<KET_ListsCustomers> KET_ListsCustomers { get; set; }
        public virtual DbSet<KEY_CustomersTherapists> KEY_CustomersTherapists { get; set; }
        public virtual DbSet<KEY_PurchaseItems> KEY_PurchaseItems { get; set; }
        public virtual DbSet<KEY_Purchases> KEY_Purchases { get; set; }
